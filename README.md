...
**[PolyForm Noncommercial License 1.0.0](LICENSE)** as of v0.5.0. Free for any noncommercial
purpose — personal use, research, study, hobby projects — and for charities, schools, public
research bodies, and government institutions, whatever their funding. **Commercial use requires
a separate license.** Open an issue or contact the author to arrange one; the license expressly
preserves the right to grant them, so commercial terms are available on request.

Releases up to and including **v0.4.28 remain MIT** and stay MIT permanently — that grant cannot
be withdrawn. Only v0.5.0 onward carries the new terms. The boundary is the last MIT commit,
[`f9c341f`](https://github.com/edisonymy/forecast-scaffold/commit/f9c341f).

The numeric-CDF construction is ported from the MIT-licensed
[forecasting-tools](https://github.com/Metaculus/forecasting-tools) project (Copyright (c) 2024
CodexVeritas). **That section remains under the MIT License** regardless of the terms above; its
full permission notice is in [THIRD-PARTY-NOTICES.md](THIRD-PARTY-NOTICES.md) and must be kept
with any copy. The aggregation rules follow the published literature (Halawi et al. 2024;
Sevilla; Satopää et al.), cited in [docs/design.md](docs/design.md).
