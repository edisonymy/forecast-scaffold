...
# released under the MIT License. This section stays MIT-licensed regardless of the terms the
# rest of the project ships under; its full permission notice is reproduced in the repository's
# THIRD-PARTY-NOTICES.md and must travel with any copy. The 0.01*location mixing term
# guarantees the platform's minimum CDF step (5e-05 per bin over 200 bins) and the 0.001
# constant provides the open-bound tail mass.
